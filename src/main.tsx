...
import ContentPage, { CreateContentPage, DetailContentPage } from '@modules/content/pages'
...
const router = createBrowserRouter([
  ...
  // Admin Pages
  {
    ...
    children: [
      ...
      {
        path: __ROUTE__.CONTENT.INDEX,
        children: [
          { index: true, Component: ContentPage },
          { path: __ROUTE__.CONTENT.NEW, Component: CreateContentPage },
          { path: __ROUTE__.CONTENT.DETAIL, Component: DetailContentPage },
        ],
      },
      {
        ...
        children: [
          ...
          { path: __ROUTE__.CUSTOMER.NEW, Component: CreateCustomerPage },
