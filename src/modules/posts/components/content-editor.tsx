      ...
      <div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-4'>
            <div className={'grid grid-cols-12 gap-4' + (isEditing ? ' md:grid-cols-1' : '')}>
              <div className={'col-span-8 space-y-2' + (isEditing ? ' md:col-span-3' : '')}>
                <FormField
              ...
              <div className={'col-span-3 space-y-2' + (isEditing ? ' md:col-span-3' : '')}>
                <FormField
                  control={form.control}
                  name='category'
                  render={({ field }) => (
